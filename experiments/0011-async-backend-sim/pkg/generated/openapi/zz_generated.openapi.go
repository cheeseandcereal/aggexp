...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.Widget":       schema_pkg_apis_aggexp_v1_Widget(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetList":   schema_pkg_apis_aggexp_v1_WidgetList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetSpec":   schema_pkg_apis_aggexp_v1_WidgetSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetStatus": schema_pkg_apis_aggexp_v1_WidgetStatus(ref),
...
func schema_pkg_apis_aggexp_v1_Widget(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a cluster-scoped projection of a resource on an async-provisioning backend. After create or update the backend simulates a ~30s provisioning wait; status.phase transitions Pending -> Provisioning -> Ready. On delete, a ~10s Deleting phase precedes removal. This apiserver is stateless beyond a short-lived poll-for-watch cache; the mock is the source of truth.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetSpec", "github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.WidgetStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_WidgetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.Widget"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0011-async-backend-sim/pkg/apis/aggexp/v1.Widget", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_WidgetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"desiredState": {
						SchemaProps: spec.SchemaProps{
							Description: "DesiredState is the intent the caller is expressing. The mock accepts any non-empty string; canonical values are \"running\" and \"stopped\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"config": {
						SchemaProps: spec.SchemaProps{
							Description: "Config is an arbitrary key/value map whose contents the mock round-trips. Changing any value triggers a new provisioning cycle.",
							Type:        []string{"object"},
...
func schema_pkg_apis_aggexp_v1_WidgetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WidgetStatus is the server's observation of the backing resource. All fields are derived live from the mock backend at read time.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is a coarse state summary: Pending, Provisioning, Ready, Deleting, or Failed.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"observedState": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedState is the mock's report of where the widget actually is. Empty during Provisioning; matches spec.desiredState once Ready.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"readyAt": {
						SchemaProps: spec.SchemaProps{
							Description: "ReadyAt is when the backend first reached the Ready phase after the last provision. Unset while Pending / Provisioning.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"message": {
						SchemaProps: spec.SchemaProps{
							Description: "Message is free-form human-readable detail from the backend.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
