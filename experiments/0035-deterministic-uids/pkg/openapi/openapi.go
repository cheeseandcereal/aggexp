// Package openapi provides minimal OpenAPI definitions for experiment 0035.
package openapi
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0035-deterministic-uids/pkg/types.Widget"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a simple resource for the deterministic-uids experiment.",
				Type:        []string{"object"},
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0035-deterministic-uids/pkg/types.WidgetList"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
