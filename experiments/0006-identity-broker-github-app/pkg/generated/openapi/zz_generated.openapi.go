...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.Repo":       schema_pkg_apis_aggexp_v1_Repo(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoList":   schema_pkg_apis_aggexp_v1_RepoList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoSpec":   schema_pkg_apis_aggexp_v1_RepoSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoStatus": schema_pkg_apis_aggexp_v1_RepoStatus(ref),
...
func schema_pkg_apis_aggexp_v1_Repo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Repo is a cluster-scoped projection of a GitHub repository. State lives on GitHub; this apiserver is stateless except for a polling cache. Resource name is <owner>.<repo-name>.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoSpec", "github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.RepoStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_RepoList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RepoList is a list of Repo objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.Repo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0006-identity-broker-github-app/pkg/apis/aggexp/v1.Repo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_RepoSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RepoSpec mirrors the relevant fields of a GitHub repo. All fields are derived from the GitHub API; the AA does not accept writes to this spec (read-only for the MVP).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"owner": {
						SchemaProps: spec.SchemaProps{
							Description: "Owner is the GitHub user or organization.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the repository name (without the owner prefix).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description is the repo's short description on GitHub.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"defaultBranch": {
						SchemaProps: spec.SchemaProps{
							Description: "DefaultBranch is the default branch (e.g. \"main\").",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"private": {
						SchemaProps: spec.SchemaProps{
							Description: "Private is true for private repos.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"language": {
						SchemaProps: spec.SchemaProps{
							Description: "Language is the primary language as reported by GitHub.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"stars": {
						SchemaProps: spec.SchemaProps{
							Description: "Stars is the number of stargazers.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"htmlURL": {
						SchemaProps: spec.SchemaProps{
							Description: "HTMLURL is the human-facing URL on GitHub.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_aggexp_v1_RepoStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RepoStatus captures the server's observation of the backing GitHub resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"observedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedAt is the wall-clock time this Repo was last refreshed from GitHub.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"etag": {
						SchemaProps: spec.SchemaProps{
							Description: "ETag is the GitHub response ETag at last observation, if any.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
