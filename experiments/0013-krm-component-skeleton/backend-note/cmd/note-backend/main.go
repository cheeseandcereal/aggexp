...
func (b *backend) GetSchema(_ context.Context, _ *krmv1.GetSchemaRequest) (*krmv1.GetSchemaResponse, error) {
	// Minimal OpenAPI v3 schema for a Note. kubectl explain uses this
	// when it can find the GVK extension.
	schema := map[string]any{
		"type":        "object",
		"description": "Note is a free-form piece of text served by the 0013 KRM skeleton.",
		"properties": map[string]any{
			...
			"spec": map[string]any{
				...
				"properties": map[string]any{
					"title": map[string]any{"type": "string", "description": "Short display title."},
					"body":  map[string]any{"type": "string", "description": "Free-form body text."},
				},
			},
			"status": map[string]any{
				...
				"properties": map[string]any{
					"updatedAt": map[string]any{"type": "string", "description": "Server-assigned last-update time."},
				},
			},
		},
