...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.Hello":       schema_pkg_apis_aggexp_v1_Hello(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloList":   schema_pkg_apis_aggexp_v1_HelloList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloSpec":   schema_pkg_apis_aggexp_v1_HelloSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloStatus": schema_pkg_apis_aggexp_v1_HelloStatus(ref),
...
func schema_pkg_apis_aggexp_v1_Hello(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Hello is a tiny cluster-scoped resource used to exercise the aggregated apiserver's CRUD + watch paths without an external backend. State lives in-memory on the server.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloSpec", "github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.HelloStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_HelloList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HelloList is a list of Hello objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.Hello"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0003-custom-authorizer-external-policy/pkg/apis/aggexp/v1.Hello", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_HelloSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HelloSpec is the user-writable portion of a Hello.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"greeting": {
						SchemaProps: spec.SchemaProps{
							Description: "Greeting is the string the server echoes back. Arbitrary.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_aggexp_v1_HelloStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HelloStatus is the server-managed portion of a Hello. The MVP-lab does not split spec/status enforcement; this field is present to match Kubernetes convention and to show up in the generated OpenAPI schema.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"observedGreeting": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedGreeting echoes back Spec.Greeting at write time. It exists to give us a status field to populate.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
