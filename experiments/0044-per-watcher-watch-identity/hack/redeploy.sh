...
EXP="${ROOT}/experiments/0044-per-watcher-watch-identity"
CLUSTER="aggexp-0044"
IMAGE="aggexp-0044:dev"
...
echo "rolled: mode=${WATCH_MODE:-push} sharedPoll=${SHARED_POLL:-false} pollInterval=${POLL_INTERVAL:-5s} upstreamBudget=${UPSTREAM_BUDGET:-0}"
