...
import (
	...
	"github.com/cheeseandcereal/aggexp/experiments/0049-locked-write-transaction/pkg/apiserver"
	...
	"github.com/cheeseandcereal/aggexp/experiments/0049-locked-write-transaction/pkg/sweep"
	perwatch "github.com/cheeseandcereal/aggexp/experiments/0049-locked-write-transaction/pkg/watch"
	"github.com/cheeseandcereal/aggexp/experiments/0049-locked-write-transaction/pkg/widgetrest"
...
type Options struct {
	*runtimeserver.Options
	...
	// 0049 locked-write transaction discipline.
	LockTxn         bool
	LockTxnAttempts int
...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.LockTxn, "lock-txn", o.LockTxn, "0049: run the post-acquire body+commit writes as a retriable transaction (CAS conflicts retry then 409, never 500). Set false for the regression baseline.")
	fs.IntVar(&o.LockTxnAttempts, "lock-txn-attempts", o.LockTxnAttempts, "0049: transaction-retry budget for the locked-write critical section")
...
func (o *Options) Run(ctx context.Context) error {
	...
	locker := locking.New(locking.Options{
		...
		RenewEnabled:  true,
		TxnEnabled:    o.LockTxn,
		TxnAttempts:   o.LockTxnAttempts,
	})
	klog.InfoS("locked-write-txn", "replica", replicaID, "enabled", o.LockTxn, "attempts", o.LockTxnAttempts)
