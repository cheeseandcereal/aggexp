...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.Widget":       schema_pkg_apis_aggexp_v1_Widget(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetList":   schema_pkg_apis_aggexp_v1_WidgetList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetSpec":   schema_pkg_apis_aggexp_v1_WidgetSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetStatus": schema_pkg_apis_aggexp_v1_WidgetStatus(ref),
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a namespace-scoped demo resource served by an aggregated apiserver. Multiple replicas of the AA all watch the same backing CRD on the host kube-apiserver via an informer; events fan out to local watchers from each replica's own broadcaster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetSpec", "github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.WidgetStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_aggexp_v1_WidgetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.Widget"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0045-read-path-reconcile-amplification/pkg/apis/aggexp/v1.Widget", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"color": {
						SchemaProps: spec.SchemaProps{
							Description: "Color is free-text.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"size": {
						SchemaProps: spec.SchemaProps{
							Description: "Size is an arbitrary int32.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_pkg_apis_aggexp_v1_WidgetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WidgetStatus is observation state.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is a free-text lifecycle phase.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
