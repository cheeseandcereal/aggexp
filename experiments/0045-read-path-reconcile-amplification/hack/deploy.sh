...
# Deploy script for experiment 0045 (read-path-reconcile-amplification).
#
# Assumes:
#   - ./hack/gen-certs.sh has been run (deploy/certs present)
#   - kind cluster aggexp-0045 exists and is the current context
...
EXP="${ROOT}/experiments/0045-read-path-reconcile-amplification"
CLUSTER="aggexp-0045"
IMAGE="aggexp-0045:dev"
