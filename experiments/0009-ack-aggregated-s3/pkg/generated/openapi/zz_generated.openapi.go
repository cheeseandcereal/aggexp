...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.Bucket":       schema_pkg_apis_aggexp_v1_Bucket(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketList":   schema_pkg_apis_aggexp_v1_BucketList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketSpec":   schema_pkg_apis_aggexp_v1_BucketSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketStatus": schema_pkg_apis_aggexp_v1_BucketStatus(ref),
...
func schema_pkg_apis_aggexp_v1_Bucket(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Bucket is a cluster-scoped projection of an AWS S3 bucket. State lives on AWS. This apiserver is stateless; Get and List are live reads against the S3 API. The Kubernetes resource name equals the S3 bucket name (globally unique on real AWS).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketSpec", "github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.BucketStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_BucketList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BucketList is a list of Bucket objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.Bucket"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0009-ack-aggregated-s3/pkg/apis/aggexp/v1.Bucket", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_BucketSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BucketSpec is the user-writable portion of a Bucket. The subset of S3's CreateBucket / PutBucketTagging inputs we model.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"region": {
						SchemaProps: spec.SchemaProps{
							Description: "Region is the AWS region. If empty on create, the server uses its default region. On read, Status.Region is authoritative.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tags": {
						SchemaProps: spec.SchemaProps{
							Description: "Tags is the bucket's tag set. Matches S3 tagging semantics (key/value, both strings).",
							Type:        []string{"object"},
...
func schema_pkg_apis_aggexp_v1_BucketStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BucketStatus is the server's observation of the backing S3 object. All fields are derived from live AWS calls at read time.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"region": {
						SchemaProps: spec.SchemaProps{
							Description: "Region is the actual region of the bucket as reported by S3.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"creationDate": {
						SchemaProps: spec.SchemaProps{
							Description: "CreationDate is when S3 created the bucket.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"observedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedAt is when the AA last observed this bucket. For live reads, it's the time of the request.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is a coarse state summary: \"Ready\" (bucket exists and is reachable) or \"Failed\" (the last observation returned an error). Failed is not persisted in the usual sense because there is no store; it is surfaced on the error path of operations that partially succeeded.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
