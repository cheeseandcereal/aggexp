// Package openapi provides minimal OpenAPI definitions for experiment 0039.
package openapi
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0039-optimistic-concurrency/pkg/types.Widget"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a simple resource for the optimistic concurrency experiment.",
				Type:        []string{"object"},
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0039-optimistic-concurrency/pkg/types.WidgetList"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
