...
func (b *MemBackend) RowsFor(obj runtime.Object) ([]metav1.TableRow, error) {
	...
	case *types.Widget:
		return []metav1.TableRow{{
			Cells:  []interface{}{v.Name, v.Spec.Color, v.Spec.Size, v.Status.Phase},
			Object: runtime.RawExtension{Object: v.DeepCopyObject()},
		}}, nil
	case *types.WidgetList:
		...
		for i := range v.Items {
			...
			rows[i] = metav1.TableRow{
				Cells:  []interface{}{w.Name, w.Spec.Color, w.Spec.Size, w.Status.Phase},
				Object: runtime.RawExtension{Object: w.DeepCopyObject()},
			}
		}
		return rows, nil
	}
