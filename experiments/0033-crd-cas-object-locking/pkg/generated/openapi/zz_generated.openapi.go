...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.Gizmo":       schema_pkg_apis_aggexp_v1_Gizmo(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoList":   schema_pkg_apis_aggexp_v1_GizmoList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoSpec":   schema_pkg_apis_aggexp_v1_GizmoSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoStatus": schema_pkg_apis_aggexp_v1_GizmoStatus(ref),
...
func schema_pkg_apis_aggexp_v1_Gizmo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Gizmo is a cluster-scoped, write-able toy resource exercised by the 0033 locking experiment.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoSpec", "github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.GizmoStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_GizmoList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GizmoList is a list of Gizmo objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.Gizmo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0033-crd-cas-object-locking/pkg/apis/aggexp/v1.Gizmo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_aggexp_v1_GizmoSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GizmoSpec is small on purpose; the experiment exercises locking, not modeling.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"color": {
						SchemaProps: spec.SchemaProps{
							Description: "Color is an arbitrary string.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"counter": {
						SchemaProps: spec.SchemaProps{
							Description: "Counter is the field demos increment under contention.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
...
func schema_pkg_apis_aggexp_v1_GizmoStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GizmoStatus records the AA pod that last wrote.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"lastWriter": {
						SchemaProps: spec.SchemaProps{
							Description: "LastWriter is the replica POD_NAME that last persisted this object.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
