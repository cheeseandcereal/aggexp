...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured":                                           schema_unstructured_Unstructured(ref),
		"k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.UnstructuredList":                                       schema_unstructured_Unstructured(ref),
...
// schema_unstructured_Unstructured is a minimal "anything goes" OpenAPI
// definition for the unstructured types the component server registers
// dynamically at startup. See pkg/server for context: the component has
// no compile-time knowledge of the backend's resource shape, so we tell
// openapi.NewDefinitionNamer that both Unstructured and UnstructuredList
// are preserve-unknown-fields objects.
func schema_unstructured_Unstructured(_ common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			VendorExtensible: spec.VendorExtensible{
				Extensions: spec.Extensions{
			...
			SchemaProps: spec.SchemaProps{
				Description: "Dynamic resource served by the 0013 KRM component skeleton. The schema is learned at startup from the backend via gRPC; this OpenAPI definition is deliberately structure-agnostic.",
				Type:        []string{"object"},
			},
		},
	}
