// Package openapi provides minimal OpenAPI definitions for experiment 0037.
package openapi
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0037-field-selectors/pkg/types.Widget"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a simple resource for the field-selector experiment.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {SchemaProps: spec.SchemaProps{
						...
						Properties: map[string]spec.Schema{
							...
							"priority": {SchemaProps: spec.SchemaProps{Type: []string{"string"}}},
						},
					}},
				},
			},
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0037-field-selectors/pkg/types.WidgetList"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
