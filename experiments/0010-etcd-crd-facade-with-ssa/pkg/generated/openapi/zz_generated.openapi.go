...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.Widget":       schema_pkg_apis_aggexp_v1_Widget(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetList":   schema_pkg_apis_aggexp_v1_WidgetList(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetSpec":   schema_pkg_apis_aggexp_v1_WidgetSpec(ref),
		"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetStatus": schema_pkg_apis_aggexp_v1_WidgetStatus(ref),
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a cluster-scoped demo resource. The aggregated apiserver exposes it; storage is forwarded to a CRD (widgetstorages.aggexpstorage.aggexp.io) on the host kube-apiserver. The AA adds value via an identity-aware facade and a small field-rename transformation between the storage and exposed shapes.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetSpec", "github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.WidgetStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_aggexp_v1_WidgetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.Widget"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cheeseandcereal/aggexp/experiments/0010-etcd-crd-facade-with-ssa/pkg/apis/aggexp/v1.Widget", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description is free-text.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"counter": {
						SchemaProps: spec.SchemaProps{
							Description: "Counter is an arbitrary int32. On the backing CRD this field is named stored_counter; the facade renames it on read/write.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"tags": {
						SchemaProps: spec.SchemaProps{
							Description: "Tags is a string-to-string map. When the caller's user name starts with \"alice-\", the facade filters this map on read to only include keys starting with \"alice-\".",
							Type:        []string{"object"},
...
func schema_pkg_apis_aggexp_v1_WidgetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WidgetStatus is observation state echoing the spec counter back.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"observedCounter": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedCounter echoes spec.counter at last server observation.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
