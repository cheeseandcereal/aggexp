...
import (
	...
	"github.com/cheeseandcereal/aggexp/experiments/0043-embedded-lock-emission-filtering/pkg/server"
)
...
func newCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "aggexp-widgets",
		Short: "aggexp experiment 0043: embedded-lock + emission-filtering over the stitched metadata-CR store",
