// Package openapi provides minimal OpenAPI definitions for experiment 0032.
package openapi
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0032-lease-based-object-locking/pkg/types.Widget"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Widget is a simple resource for the lease-locking experiment.",
				Type:        []string{"object"},
	...
	defs["github.com/cheeseandcereal/aggexp/experiments/0032-lease-based-object-locking/pkg/types.WidgetList"] = common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
